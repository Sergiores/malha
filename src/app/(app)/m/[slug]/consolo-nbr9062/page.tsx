...
import { FormConsolo } from "./form-consolo";

export default async function ConsoloPage({
  params,
  searchParams,
}: {
  ...
  const [clientes, pre] = await Promise.all([
    clientesParaSelecao(),
    carregarParaFormulario(await searchParams, "consolo-nbr9062"),
  ]);
